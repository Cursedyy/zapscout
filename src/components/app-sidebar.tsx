...
import { Search, KanbanSquare, MessageSquare, BarChart3, Settings, LogOut, Zap, Menu, X, Sparkles, Clock, Send, MessageCircle, Repeat, Bot, Shield, Activity } from "lucide-react";
