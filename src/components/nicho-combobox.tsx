...
export const NICHOS_CATEGORIAS: NichoCategoria[] = [
  ...
  {
    categoria: "Adulto & Lifestyle",
    emoji: "🔥",
    itens: [
      { emoji: "❤️‍🔥", nome: "Sex shop" },
      { emoji: "👙", nome: "Loja de lingerie" },
      { emoji: "💋", nome: "Casa de massagem tântrica" },
      { emoji: "🕺", nome: "Casa noturna / balada" },
      { emoji: "🎭", nome: "Casa de swing" },
      { emoji: "🚬", nome: "Tabacaria" },
      { emoji: "🌿", nome: "Head shop / growshop" },
      { emoji: "🍷", nome: "Wine bar / lounge" },
      { emoji: "🎲", nome: "Casa de jogos / bilhar" },
    ],
  },
  {
    categoria: "Arte corporal & Personalização",
    emoji: "🎨",
    itens: [
      { emoji: "🖋️", nome: "Estúdio de tatuagem" },
      { emoji: "💎", nome: "Piercing" },
      { emoji: "🧷", nome: "Micropigmentação" },
      { emoji: "🖨️", nome: "Gráfica rápida" },
      { emoji: "👕", nome: "Estamparia / camisetas" },
      { emoji: "🏷️", nome: "Comunicação visual / adesivos" },
      { emoji: "🎁", nome: "Brindes personalizados" },
    ],
  },
  {
    categoria: "Serviços urbanos & Diversos",
    emoji: "🧭",
    itens: [
      { emoji: "🔑", nome: "Chaveiro" },
      { emoji: "📦", nome: "Mudanças e fretes" },
      { emoji: "🧳", nome: "Consertos de malas / bolsas" },
      { emoji: "🥾", nome: "Sapataria / consertos" },
      { emoji: "🚲", nome: "Loja de bicicletas" },
      { emoji: "🎸", nome: "Loja de instrumentos musicais" },
      { emoji: "🐠", nome: "Aquarismo" },
      { emoji: "💐", nome: "Floricultura" },
      { emoji: "🕯️", nome: "Funerária" },
      { emoji: "💱", nome: "Casa de câmbio" },
      { emoji: "🏢", nome: "Coworking" },
      { emoji: "📮", nome: "Franquia de correios / envios" },
      { emoji: "🧼", nome: "Lava-jato ecológico" },
      { emoji: "🛵", nome: "Motoboy / entregas" },
    ],
  },
];
